...
class PlainPizza1 implements Pizza {
    @Override
...
public class DecoratorDemo {
    public static void main(String[] args) {
        ...
        Pizza myPizza = new MargheritaPizza();  //200

        // Add Extra Cheese
        myPizza = new ExtraCheese(myPizza); //40

        // Add Olives
        myPizza = new Olives(myPizza);  //30

        // Add Stuffed Crust
        myPizza = new StuffedCrust(myPizza); //50
//        Pizza olivePizza= new Olives(new MargheritaPizza());//
//        myPizza = new StuffedCrust(olivePizza);
