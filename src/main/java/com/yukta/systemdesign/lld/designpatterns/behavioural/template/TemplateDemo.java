...
class EmailNotification1 extends NotificationSender {
...
class SMSNotification1 extends NotificationSender {
...
public class TemplateDemo {
    public static void main(String[] args) {
        NotificationSender emailSender = new EmailNotification1();
        emailSender.send("john@example.com", "Welcome to TUF+!");

        System.out.println(" ");

        NotificationSender smsSender = new SMSNotification1();
