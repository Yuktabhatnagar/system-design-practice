package com.yukta.systemdesign.lld.designpatterns.behavioural.memento;
...
// Caretaker
class ResumeHistory {
    private Stack<ResumeEdit.Memento> history = new Stack<>();

    public void save(ResumeEdit editor) {
        history.push(editor.save());
    }

    public void undo(ResumeEdit editor) {
        if (!history.isEmpty()) {
...
public class MementoDemo {
    public static void main(String[] args) {
        ResumeEdit editor = new ResumeEdit();
